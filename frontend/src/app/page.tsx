    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-1/2 top-0 h-[600px] w-[900px] -translate-x-1/2 rounded-full bg-gradient-to-b from-primary-200/40 to-transparent blur-3xl" />
          <div className="absolute right-0 top-1/2 h-[400px] w-[400px] rounded-full bg-accent-200/30 blur-3xl" />
          <div className="absolute left-0 bottom-0 h-[300px] w-[300px] rounded-full bg-primary-300/20 blur-3xl" />
        </div>

        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            {/* Badge */}
            <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full bg-primary-100/60 px-4 py-1.5 text-sm font-medium text-primary-700 ring-1 ring-primary-200/50 backdrop-blur-sm">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
              AI视频
              <span className="bg-gradient-to-r from-primary-600 via-fuchsia-500 to-accent-500 bg-clip-text text-transparent">
                供需平台
              </span>
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              <Link href="/orders" className="btn-primary gap-2 text-base px-8 py-3">
                发布需求
      ...
      <section className="relative py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
            {features.map((f) => (
              <div key={f.title} className="card-hover group p-8 text-center">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            {categories.map((cat) => (
              <Link
                ...
                className="card-hover group flex flex-col items-center p-6"
              >
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              <div key={item.step} className="relative text-center">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-accent-500 text-lg font-bold text-white shadow-lg">
                  {item.step}
                </div>
