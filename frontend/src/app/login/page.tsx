      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-2xl font-bold text-gray-900">登录 AI视频工场</h2>
            <p className="mt-2 text-sm text-gray-500">手机号验证码快速登录</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            还没有账号？<Link href="/register" className="font-medium text-primary-600 hover:text-primary-500">免费注册</Link>
          </p>
        </div>
